...
// +----------------------------------------------------------------------+
// | Originado do Projeto BBBoletoFree que tiveram colabora&ccedil;ões de Daniel |
...
<meta name="Generator"
	content="Projeto BoletoPHP - www.boletophp.com.br - Licen&ccedil;a GPL" />
<style type=text/css>
<!--
.cp {
		...
		<TR>
			<TD valign=top class=cp><DIV ALIGN="left">
					...
					<li>Imprima em impressora jato de tinta (ink jet) ou laser em
						qualidade normal ou alta (N&atilde;o use modo econ&ocirc;mico).<br>

					<li>Utilize folha A4 (210 x 297 mm) ou Carta (216 x 279 mm) e
						margens m&iacute;nimas &agrave; esquerda e &agrave; direita do formul&aacute;rio.<br>

					<li>Corte na linha indicada. N&atilde;o rasure, risque, fure ou dobre a
						regi&atilde;o onde se encontra o c&oacute;digo de barras.<br>

					<li>Caso n&atilde;o apare&ccedil;a o c&oacute;digo de barras no final, clique em F5 para
						atualizar esta tela.

					<li>Caso tenha problemas ao imprimir, copie a seq&uuml;encia num&eacute;rica
						abaixo e pague no caixa eletr&ocirc;nico ou no internet banking:<br>
					<br> <span class="ld2">
	...
	<table cellspacing=0 cellpadding=0 border=0>
		<tbody>
			<tr>
				...
				<td class=ct valign=top width=7 height=13><img height=13
					src=<?php echo APP_URL_PUBLIC?>img/boletos/1.png width=1 border=0></td>
				<td class=ct valign=top width=126 height=13>Ag&ecirc;ncia/C&oacute;digo do
					Cedente</td>
				<td class=ct valign=top width=7 height=13><img height=13
					src=<?php echo APP_URL_PUBLIC?>img/boletos/1.png width=1 border=0></td>
   ...
   <?php echo $dadosboleto["data_processamento"]?>
     ...
     <?php echo $dadosboleto["nosso_numero"]?>
			...
			<tr>
				...
				<td valign=top width=7 height=1><img height=1 src=<?php echo APP_URL_PUBLIC?>img/boletos/2.png
					width=7 border=0></td>
				<td valign=top width=153 height=1><img height=1
					src=<?php echo APP_URL_PUBLIC?>img/boletos/2.png width=153 border=0></td>
				<td valign=top width=7 height=1><img height=1 src=<?php echo APP_URL_PUBLIC?>img/boletos/2.png
					width=7 border=0></td>
				...
				<td valign=top width=7 height=1><img height=1 src=<?php echo APP_URL_PUBLIC?>img/boletos/2.png
					width=7 border=0></td>
				<td valign=top width=82 height=1><img height=1 src=<?php echo APP_URL_PUBLIC?>img/boletos/2.png
 ...
 <?php echo $dadosboleto["quantidade"]?>
   ...
   <?php echo $dadosboleto["valor_boleto"]?>
			...
			<tr>
				...
				<td valign=top width=7 height=1><img height=1 src=<?php echo APP_URL_PUBLIC?>img/boletos/2.png
					width=7 border=0></td>
				<td valign=top width=31 height=1><img height=1 src=<?php echo APP_URL_PUBLIC?>img/boletos/2.png
					width=31 border=0></td>
				<td valign=top width=7 height=1><img height=1 src=<?php echo APP_URL_PUBLIC?>img/boletos/2.png
					width=7 border=0></td>
				<td valign=top width=83 height=1><img height=1 src=<?php echo APP_URL_PUBLIC?>img/boletos/2.png
				...
				<td valign=top width=123 height=1><img height=1
					src=<?php echo APP_URL_PUBLIC?>img/boletos/2.png width=123 border=0></td>
				<td valign=top width=7 height=1><img height=1 src=<?php echo APP_URL_PUBLIC?>img/boletos/2.png
					width=7 border=0></td>
				<td valign=top width=72 height=1><img height=1 src=<?php echo APP_URL_PUBLIC?>img/boletos/2.png
					width=72 border=0></td>
	...
	<table cellspacing=0 cellpadding=0 width=666 border=0>
		<tbody>
			<tr>
				...
				<td valign=top width=468 rowspan=5><font class=ct>Instru&ccedil;&otilde;es (Texto
